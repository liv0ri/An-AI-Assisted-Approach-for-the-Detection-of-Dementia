...
def train_and_save_text_time_model(dataset_type, remove_short_sentences):
    ...
    for train_val_index, test_index in kf.split(all_word_ids, all_labels):
        ...
        fold_model_path = os.path.join(model_save_dir, f"text_time_model_fold_{fold_number}.keras")
...
if __name__ == "__main__":
    ...
    train_and_save_text_time_model(dataset_type="augmented", remove_short_sentences=False)
