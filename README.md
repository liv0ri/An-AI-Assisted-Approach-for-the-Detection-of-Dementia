# AI-Assisted Early Dementia Detection from Speech & Language

[![Final Year Project](https://img.shields.io/badge/🎓%20Final%20Year%20Project-Department%20of%20AI%20%7C%202026-blue?style=for-the-badge&logo=graduation-cap&logoColor=white)](#)

This repository contains the research, experiments, and implementation of an **AI-assisted multi-modal system** for the **early detection of dementia** using speech and language analysis.

 [![Python 3.9+](https://img.shields.io/badge/Python-3.9%2B-blue.svg)](https://www.python.org/downloads/)[![MIT License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

 [![](https://img.shields.io/badge/Dataset-Pitt%20Corpus-green?style=flat-square)](https://talkbank.org/dementia/access/English/Pitt.html)[![](https://img.shields.io/badge/Dataset-ADReSSo-orange?style=flat-square)](https://talkbank.org/dementia/ADReSSo-2021/index.html)
...
```bash
Python 3.9+PyTorch / TensorFlowCUDA-capable GPU (recommended)
```