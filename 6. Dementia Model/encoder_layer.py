...
class EncoderLayer(nn.Module):
    def __init__(self, d_model, ffn_hidden=768, drop_prob=0.5): 
        ...
        self.cross_attention = CrossAttention(d_model) # This layer will allow information flow between two different modalities.
    ...
    def forward(self, query, key): 
        _x = query # Stores the original query input for the residual connection.
        x = self.cross_attention(query, key) # Computes cross-attention, where 'query' queries 'key'.
